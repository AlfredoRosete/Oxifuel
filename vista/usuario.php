...
<?php include 'formularios/form.acceso.php';?>
    </div>
  </div>
</div>
...
<div class="">
    ...
    <button type="button" class="btn btn-default navbar-btn" data-toggle="modal" data-target=".bs-example-modal-sm" > <span> <i class="glyphicon glyphicon-log-in"></i></span> Iniciar sesión </button>
