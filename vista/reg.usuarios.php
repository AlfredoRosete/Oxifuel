...
<a href="reg.usuarios.php" role="button"> <button type="button" class="btn btn-default navbar-btn"   > <span> <i class="glyphicon glyphicon-log-out"></i></span>  Cerrar Sesion  </button></a> 
...
<div class="container">
  <?php 
include 'listas/list.usuario.php';
   ?>
